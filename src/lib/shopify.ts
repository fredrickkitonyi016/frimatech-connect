...
export const SHOPIFY_STORE_PERMANENT_DOMAIN = 'frimatech-connect-8usuw.myshopify.com';
export const SHOPIFY_STOREFRONT_URL = `https://${SHOPIFY_STORE_PERMANENT_DOMAIN}/api/${SHOPIFY_API_VERSION}/graphql.json`;
export const SHOPIFY_STOREFRONT_TOKEN = '644ee6858ee1138668ff17334387c231';
